...
if($nom=='' || $rue=='' || $ville=='' || $code_post=='' || $num_tva=='')
   ...
   $message= "<h1>$lang_oubli_champ</h1>";
    include('form_nc.php'); // On inclus le formulaire d'identification
    exit;
    }
if ($login !=''){
...
$sql1 = "INSERT INTO " . $tblprefluc ."client(nom, nom2, rue, ville, cp, num_tva, login, pass, mail, civ, tel, fax, gsm) VALUES ('$nom', '$nom_sup', '$rue', '$ville', '$code_post', '$num_tva', '$login', '$pass', '$mail_cli', '$civ', '$tel', '$fax', '$gsm')";
