...
$sql_rappel="UPDATE ".$tblpref."facture SET r3='".$date_rappel."' WHERE num='".$num_doc."'";
...
$subject = "Troisième Rappel: Facture_".$num_doc."_".$nom; 
$message = "<p>Madame, Monsieur,</p>
<p>Nous constatons avec regret que vous n’avez pas donn&eacute; suite &agrave; notre pr&eacute;c&eacute;dent rappel et que votre compte reste toujours d&eacute;biteur de ".$apayer." euros. </p>
<p>Ce montant correspond &agrave; la facture n°".$num_doc." rest&eacute;e impay&eacute;e.</p>
<p><strong><b>Nous vous mettons donc en demeure de nous r&eacute;gler l’int&eacute;gralit&eacute; de la somme pour le ".$date_echeance.".</b></strong></p>
<p>Pass&eacute; ce d&eacute;lai, nous confierons le dossier &acirc; nos huissiers, Chartier & Partners, qui mettront en &oelig;uvre toutes les d&eacute;marches n&eacute;cessaires au recouvrement de notre cr&eacute;ance. </p>
<p>Dans l’attente d’un r&egrave;glement, nous vous prions d’agr&eacute;er, Monsieur, nos salutations distingu&eacute;es.</p>
...
$mail->Subject = "Troisième Rappel: Facture_".$num_doc."_".$nom; 
$mail->IsHTML(true);

$date_echeance=date('d-m-Y', strtotime('+8 day'));
