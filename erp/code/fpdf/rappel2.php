...
$sql_rappel="UPDATE ".$tblpref."facture SET r2='".$date_rappel."' WHERE num='".$num_doc."'";
...
$subject = "Deuxième Rappel: Facture_".$num_doc."_".$nom; 

$message = "<p>Madame, Monsieur,</p>
<p>Nous constatons que votre compte client pr&eacute;sente toujours un solde d&eacute;biteur de ".$apayer." euros. </p>
<p>Ce montant correspond &agrave; la facture n°".$num_doc." rest&eacute;e impay&eacute;e malgr&eacute; notre pr&eacute;c&eacute;dent rappel.</p>
<p>Nous vous demandons de bien vouloir r&eacute;gulariser cette situation dans les plus bref d&eacute;lais. Dans le cas o&uacute; votre r&eacute;glement aurait &eacute;t&eacute; adress&eacute; entre temps, nous vous prions de ne pas tenir compte de la pr&eacute;sente.</p>
...
$mail->Subject = "Deuxième Rappel: Facture_".$num_doc."_".$nom; 
$mail->IsHTML(true);
