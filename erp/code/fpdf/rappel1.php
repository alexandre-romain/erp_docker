...
//ENREGISTREMENT DE L'ENVOI DU RAPPEL EN BDD
$date_rappel=date('d-m-Y');
$sql_rappel="UPDATE ".$tblpref."facture SET r1='".$date_rappel."' WHERE num='".$num_doc."'";
$req_rappel=mysql_query($sql_rappel);
...
$total_bebat = '0.00';
		...
		$date_bl = $data['date'];
			...
			$pdf->SetX(12);
			$pdf->Row($entrep_nom,$social_ville,$social_rue,$social_cp,$tel,$fax,$tva_vend,$compte,$mail,$web,$num_doc,$date_num_doc,$date_doc,$echeance,$total_htva,$total_tva,$coment,$tot_tva_inc,$num_client,$nom,$nom2,$rue,$numero,$boite,$ville,$cp,$num_tva,$mail_client,$tel_client,$fax_client,array("Bon de livraison n°".$num_bl." du ".$date_bl));
			$pdf->Ln(1);
			$pdf->SetX(12);
			...
			$pdf->Ln(1);
			$sql2 = "SELECT " . $tblpref ."cont_bl.num, reference, marque, recupel, reprobel, bebat , garantie, quanti, serial, uni, article, taux_tva, prix_htva, p_u_jour, tot_art_htva FROM " . $tblpref ."cont_bl RIGHT JOIN " . $tblpref ."article on " . $tblpref ."cont_bl.article_num = " . $tblpref ."article.num WHERE  bl_num = $num_bl";
...
/*$to = $mail_client; 
$from = "compta@fastitservice.be"; 
$subject = "Premier Rappel: Facture_".$num_doc."_".$nom; 
$message = "<p>Madame, Monsieur,</p>
<p>Sauf erreur ou omission de notre part, nous constatons que votre compte client pr&eacute;sente &agrave; ce jour un solde d&eacute;biteur de ".$apayer." euros. </p>
<p>Ce montant correspond &agrave; la facture n°".$num_doc." rest&eacute;e impay&eacute;e.</p>
<p>L’&eacute;ch&eacute;ance &eacute;tant d&eacute;pass&eacute;e, nous vous demandons de bien vouloir r&eacute;gulariser cette situation au plus vite. Dans le cas o&uacute; votre r&eacute;glement aurait &eacute;t&eacute; adress&eacute; entre temps, nous vous prions de ne pas tenir compte de la pr&eacute;sente.</p>
<p>Vous remerciant par avance, nous vous prions d'agr&eacute;er, Madame, Monsieur, l’expression de nos salutations distingu&eacute;es.</p>
<p style=\"text-align:left\">Fast IT Service</p>
<p><strong>Rappel des informations de paiement:</strong></p>
<p>IBAN : BE70 3630 8937 4325</p>
<p>BIC/SWIFT : BBRUEBB</p>
<p>Communication: Facture_".$num_doc."_".$nom."</p>
<p>Montant: ".$apayer." euros</p>
<p>Titulaire du compte: Fast IT Service SPRL</p>
";

//$message = "<p>Bonjour,</p><br/><p>Ceci est le premier rappel de la facture n°".$num_doc." d\'un montant de ".$apayer.".</p><p>Nous vous prions de bien vouloir la r&eacute;gler dans les plus bref d&eacute;lais</p><br/><p>Pour toute information supplémentaire, contactez-nous:</p><br/><p>- Par Mail: info@fastitservice.be</p><p>- Par Téléphone: 081/730.15.05</p>";
...
// attachment name
$filename = "Fact_".$num_doc."_".$nom.".pdf";

// encode data (puts attachment in proper format)
$pdfdoc = $pdf->Output("Fact_".$num_doc."_".$nom.".pdf", "S");
...
$mail->Subject = "Premier Rappel: Facture_".$num_doc."_".$nom; 
$mail->IsHTML(true);
...
header('Location: ../lister_factures_non_reglees.php'); 
?>