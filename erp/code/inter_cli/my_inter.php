...
llxHeader('','Mes Interventions Client','');
		 ...
		 //liste des colonnes avec leur comportement respectif + eventuellement style via CSS
			...
			//Client
			{
				...
				<?php
					...
					$sql2 = "SELECT s.rowid, s.nom";
					$sql2 .= " FROM ".MAIN_DB_PREFIX."societe as s";
					$sql2 .= " WHERE s.client='1' AND s.rowid!='6' ";
...
<br/>
<!-- On descend la liste d'une ligne pour centrage  -->
<div id="types" class="art-postheader" align="center">Liste de mes Interventions Clients</div>
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tableinter">
	...
	// On récupère les inter de l'user
	...
	$sql .= " WHERE i.fk_createur='$user->id'";
			...
			if ($num)
			{
				while ($i < $num)
				{
							...
							if ($obj)
							{
								...
								print '<td align="center">'.utf8_decode($obj->snom).'</td>';
