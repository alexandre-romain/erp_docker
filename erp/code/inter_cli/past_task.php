...
$res=0;
llxHeader('','Liste des T&acirc;ches Clotur&eacute;es','');
?>
	...
	<!-- DT antivirus -->
		...
		[
		 //liste des colonnes avec leur comportement respectif + eventuellement style via CSS
			...
			//Nom
			{
				cssclass: "longfield", //possibilités dans validate ligne 747
				sName: "nom",
...
<body>
    ...
    <form id="formAddNewRow" action="#" title="Ajouter un emplacement" style="width:100px;min-width:100px">
            ...
            <label for="descr">Description</label><br />
      		<input type="text" size="25" name="descr" id="descr" rel="7"/>
            <br /><br />
...
<br/>
<!-- On descend la liste d'une ligne pour centrage  -->
<div id="types" class="art-postheader" align="center">Liste des T&acirc;ches cl&ocirc;tur&eacute;es</div>
			...
			if ($num)
			{
				while ($i < $num)
				{
							...
							if ($obj)
							{
                                ...
                                <input type="hidden" name="place" id="place" value="list_past"/>
