...
llxHeader('','Interventions Client Clotur&eacute;es','');
...
<br/>
<!-- On descend la liste d'une ligne pour centrage  -->
<div id="types" class="art-postheader" align="center">Liste des Interventions Clients (Etat = Clotur&eacute;e)</div>
