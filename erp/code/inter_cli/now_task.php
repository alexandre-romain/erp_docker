...
$res=0;
llxHeader('','Liste des T&acirc;ches en Cours','');
?>
...
<br/>
<!-- On descend la liste d'une ligne pour centrage  -->
<div id="types" class="art-postheader" align="center">Liste des T&acirc;ches en cours</div>
			...
			if ($num)
			{
				while ($i < $num)
				{
							...
							if ($obj)
							{
                                ...
                                <input type="hidden" name="place" id="place" value="list_now"/>
