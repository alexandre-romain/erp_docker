...
if($nom=='' || $rue=='' || $ville=='' || $code_post=='' || $num_tva=='')
    ...
    include('new-form_client.php'); // On inclus le formulaire d'identification
    exit;
    }
...
$sql = "SELECT * FROM " . $tblprefluc ."client WHERE login = '".$login."'";
...
$sql2 = "UPDATE " . $tblprefluc ."client SET boite='" . $boite . "', numero='" . $numero . "', fax='" . $fax . "', tel='" . $tel . "', gsm='" . $gsm . "', civ='" . $civ . "', nom='" . $nom . "', mail='" . $mail_cli . "', num_tva='" . $num_tva . "', nom2='" . $nom_sup . "', rue='" .$rue . "', ville='" . $ville . "', cp='" . $code_post . "' WHERE num_client = '" . $num . "'";
mysql_query($sql2) OR die("<p>Erreur Mysql<br/>$sql2<br/>".mysql_error()."</p>");


/* ancien systeme d'entree pour les clients ..

if($pass2 !='' and $login != '')
    {
$sql2 = "UPDATE " . $tblprefluc ."client SET login='" . $login . "', pass='" . $pass . "' WHERE num_client = '" . $num . "'";
mysql_query($sql2) OR die("<p>Erreur Mysql<br/>$sql2<br/>".mysql_error()."</p>");
}

if($pass2 !='' and $login2 != '')
    {
$sql2 = "UPDATE " . $tblprefluc ."client SET login='" . $login2 . "', pass='" . $pass . "' WHERE num_client = '" . $num . "'";
mysql_query($sql2) OR die("<p>Erreur Mysql<br/>$sql2<br/>".mysql_error()."</p>");
$to = "$mail_cli";
$from = "$mail_admin" ;
