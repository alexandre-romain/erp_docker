    ...
    $.fn.makeEditable = function (options) {
            ...
            var oDefaultEditableSettings = {
                ...
                "callback": function (sValue, settings) {
                    ...
                    if (sNewCellValue == sValue) {
                        ...
                        status = "success";
						window.location.reload(); //Reload pour affichage correct
                    } else {
                        var aPos = oTable.fnGetPosition(this);
                        oTable.fnUpdate(sOldValue, aPos[0], aPos[2]);
                        //properties.fnShowError(sValue, "update"); //Sinon pop-up renvoyant la valeur de l'entrée //Soucis sur date comme elle sont converties
                        status = "failure";
						window.location.reload(); //Reload pour dates
                    }
        ...
        */
        function fnOnDeleting(tr, id, fnDeleteRow) {
            return confirm("\312tes vous certain de vouloir archiver cette entr\351e ? \n\n Cette action est d\351finitive et irr\351versible !!"); ;
        }
        ...
        */
        ...
        var defaults = {
            ...
            oAddNewRowOkButtonOptions: { label: "Enregistrer" },
            oAddNewRowCancelButtonOptions: { label: "Annuler" },
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
                // Suppression de l'ajout automatique des boutons ajout/suppression
				/*
