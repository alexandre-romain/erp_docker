...
echo $_REQUEST['datesign'].'<br/>';
//Calucl des dates
if (isset($_REQUEST['datesign'])) {
...
else if (isset($_REQUEST['datesign_fix'])) {
	$date_r=$_REQUEST['datesign_fix'];
	//La date de renouvellement
	$datesign_sec=strtotime($date_r);
	$datesign=date('d-m-Y', strtotime('-'.$month_add.' month', $datesign_sec));
	$date_r=dateEU_to_dateUSA($date_r);
}
...
if (isset($_REQUEST['contrat']) && $_REQUEST['contrat'] == 'oui') {
	...
	if (isset($_REQUEST['sign']) && $_REQUEST['sign'] == 'oui') {
		//On insère
		$sql="INSERT INTO ".$tblpref."contrat_maintenance(id_parc, cli, prix_mois, type_fact, prix_traite, nbr_pc, nbr_laptop, nbr_server, nbr_mobile, nbr_printer, sign, date_sign) VALUES ('".$id_parc."', '".$cli."', '".$p_month_c."', '".$facturation."', '".$prix_c."', '".$nbr_pc."', '".$nbr_laptop."', '".$nbr_server."', '".$nbr_mobile."', '".$nbr_printer."', '1', '".dateEU_to_dateUSA($datesign)."')";
		$req=mysql_query($sql);
		echo $sql.'<br/>';
		$id_contrat=mysql_insert_id();
		//On insère les données de nbr composante & prix afin de conserver l'historique.
		$sql="INSERT INTO ".$tblpref."contrat_echeance(id_contrat, nbr_pc, nbr_laptop, nbr_server, nbr_mobile, nbr_printer, prix_mois, prix_traite, echeance) VALUES ('".$id_contrat."', '".$nbr_pc."', '".$nbr_laptop."', '".$nbr_server."', '".$nbr_mobile."', '".$nbr_printer."', '".$p_month_c."', '".$prix_c."', '".$date_r."')";
		$req=mysql_query($sql);
		echo $sql.'<br/>';
	...
	//Sinon 
		...
		$sql="INSERT INTO ".$tblpref."contrat_maintenance(id_parc, cli, prix_mois, type_fact, prix_traite, nbr_pc, nbr_laptop, nbr_server, nbr_mobile, nbr_printer, sign) VALUES ('".$id_parc."', '".$cli."', '".$p_month_c."', '".$facturation."', '".$prix_c."', '".$nbr_pc."', '".$nbr_laptop."', '".$nbr_server."', '".$nbr_mobile."', '".$nbr_printer."', '0')";
		$req=mysql_query($sql);
		echo $sql.'<br/>';
	}
}
...
if (isset($_REQUEST['monitoring']) && $_REQUEST['monitoring'] == 'oui') {
	...
	if (isset($_REQUEST['sign_m']) && $_REQUEST['sign_m'] == 'oui') {
		//On insère
		$sql="INSERT INTO ".$tblpref."monitoring(id_parc, cli, prix_mois, type_fact, prix_traite, nbr_pc, nbr_laptop, nbr_server, nbr_mobile, nbr_printer, sign, date_sign) VALUES ('".$id_parc."', '".$cli."', '".$p_month_m."', '".$facturation."', '".$prix_m."', '".$nbr_pc."', '".$nbr_laptop."', '".$nbr_server."', '".$nbr_mobile."', '".$nbr_printer."', '1', '".dateEU_to_dateUSA($datesign)."')";
		$req=mysql_query($sql);
		echo $sql.'<br/>';
	...
	//Sinon
		...
		$sql="INSERT INTO ".$tblpref."monitoring(id_parc, cli, prix_mois, type_fact, prix_traite, nbr_pc, nbr_laptop, nbr_server, nbr_mobile, nbr_printer, sign) VALUES ('".$id_parc."', '".$cli."', '".$p_month_m."', '".$facturation."', '".$prix_m."', '".$nbr_pc."', '".$nbr_laptop."', '".$nbr_server."', '".$nbr_mobile."', '".$nbr_printer."', '0')";
		$req=mysql_query($sql);
		echo $sql.'<br/>';
	}
}
...
session_start();
$_SESSION['message']="G&eacute;n&eacute;ration effectu&eacute;.";
