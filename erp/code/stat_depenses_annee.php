...
<table class="main_table" width="500" align="center">
  	<tr>
		<td colspan="2" class="main_table_header"><?php echo $lang_choisissez; ?> la p&eacute;riode</td> 
    </tr>
  	<tr>
    	<td class="main_table">
        	<select name="mois_1">
...
?>
<table class="main_table" width="760px" align="center">
  	<tr>
		<td class="main_table_header" colspan="2"><?php echo "Tri des achats par fournisseur - Période : ".$annee_1; ?></td>
   	</tr>
	<?php
