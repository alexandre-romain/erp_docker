...
<?php 
if ($message !='') { 
 echo"<table><tr><td><h2>$message</h2></td></tr></table>"; 
}
if ($user_dev == n) {
...
exit;  
 ...
 ?>
<?php
$sql = "SELECT login, mail, explic, num_dev, tot_htva, tot_tva, DATE_FORMAT(date,'%d/%m/%Y') AS date, nom
       FROM " . $tblprefluc ."devis RIGHT JOIN " . $tblprefluc ."client on " . $tblprefluc ."devis.client_num = num_client
...
<center><table class="boiteaction">
  ...
  <tr>
	...
	<th><a href="lister_devis.php?ordre=nom">Dénomination</a> </th>
...
while($data = mysql_fetch_array($req))
  ...
  <tr class="texte<?php echo"$line" ?>" onmouseover="this.className='highlight'" onmouseout="this.className='texte<?php echo"$line" ?>'">
    ...
    <td class="highlight">
					 <a href="new-edit_devis.php?num_dev=<?php echo $num_dev; ?>&amp;nom=<?php echo $nom_html; ?>"> 
...
if($mail != ''){ ?>
	<td class="highlight">
			...
			<img src="image/pdf.gif" alt="Envoyer par mail au client" align="middle" border="0" ></a></td>	 
<?php
}else{?>
	<td class="highlight">&nbsp;</td>
<?php
 ...
 <td class="highlight">
		 ...
		 onClick="return confirmDelete('<?php echo"$lang_convert_dev $num_dev $lang_convert_dev2 "; ?>')"
		  align="middle" border="0" ><img src="image/icon_lol.gif" border="0" alt="Passer en commande"></a></td>
 <td class="highlight">
			...
			align="middle" border="0" ><img src="image/icon_cry.gif" border="0" alt="<?php echo $lang_devis_perdre; ?>"></a></td></tr>
<?php
		}
 ?>
  </tr><tr>
