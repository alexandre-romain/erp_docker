...
?>
<form action="./include/ajax/command_done.php" method="post">
<!--LISTE-->
<div class="portion">
    <!-- TITRE - LISTE -->
    ...
    <div class="content_traitement" id="liste">
    	<div class="center"><button class="button_act button--shikoba button--border-thin medium" type="submit"><i class="button__icon fa fa-check"></i><span>Commander</span></button></div>
    	<table class="base" width="100%" id="list">
            ...
            $sql .= " WHERE ( (bl.fact_num = '0') OR (bc.bl = '0') ) AND a.marge != '0' AND ((cb.commande = NULL) OR (cb.commande = '0000-00-00') OR (cb.commande = 'non')) AND bc.mask_list != 1";
			if ($_REQUEST['fourn'] != 'tout') {
				$sql .= " AND cb.fourn = '".$_REQUEST['fourn']."'";
			}
            $req=mysql_query($sql);
            $i=0;
            while ($obj = mysql_fetch_object($req)) {
                ...
                <tr>
                    ...
                    <td id="empl_com_<?php echo $obj->cbnum; ?>">
                        <input type="checkbox" name="to_com[]" value="cc_<?php echo $obj->cbnum; ?>" checked="checked"/>
                    </td>
                    <td>
                    	<?php 
			...
			if ($_REQUEST['fourn'] != 'tout') {
				$sql .= " AND a.fourn = '".$_REQUEST['fourn']."'";
			}
			$req=mysql_query($sql);
			while ($obj = mysql_fetch_object($req)) {
                ...
                <tr>
                    ...
                    <td style="widtd:7%"><input type="checkbox" name="to_com[]" value="cs_<?php echo $obj->num; ?>" checked="checked"/></td>
