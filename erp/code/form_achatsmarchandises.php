...
$annee = date("Y");
?>
<!--CREATION ACHAT MARCHANDISES-->
<div class="portion">
    <!-- TITRE - CREATION ACHAT MARCHANDISES -->
    <div class="choice_action">
        <span class="fa-stack fa-lg">
          <i class="fa fa-square-o fa-stack-2x"></i>
          <i class="fa fa-list fa-stack-1x"></i>
        </span>
        Ajouter un achat (Achats Marchandises)
    ...
    <!-- CONTENT - CREATION ACHAT MARCHANDISES -->
    <div class="content_traitement" id="create">
        <form action="form_achatsmarchandises_suite.php" method="post" name="depense" id="depense">
        <table class="base" width="100%">
            ...
            <tr>
                ...
                <td class="left" ><input name="lib" type="text" id="lib" size="30" maxlength="30" class="styled"> (ex. : n&deg; facture)</td>
            </tr>
            <tr>
                <td class="right"><?php echo $lang_prix_h_tva;?> :</td>
                <td class="left" ><input name="prix" type="text" id="prix" class="styled"> &euro; (ex. : 764.36) </td>
            </tr>
            <tr>
                <td class="right">Date :</td>
                <td class="left">
                    <input type="text" name="date" value="<?php echo"$jour/$mois/$annee" ?>" class="styled datepicker">
                </td>
            </tr>   
        </table>
        <div class="center">
